...
def main(start_n=100, end_n=200, step_n=10, num_trials=5):
    ...
    plt.savefig('/workspace/images/average_error_plot.png')
    ...
    plt.legend()
    plt.savefig('/workspace/images/execution_time_plot.png')

if __name__ == '__main__':
    # main()
    main(start_n=1000, end_n=5000, step_n=1000, num_trials=1000)
